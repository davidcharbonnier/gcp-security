...
module "dev-sec-kms" {
  ...
  source     = "git@github.com:GoogleCloudPlatform/cloud-foundation-fabric.git//modules/kms?ref=v36.2.0"
...
module "dev-cas" {
  ...
  source         = "git@github.com:GoogleCloudPlatform/cloud-foundation-fabric.git//modules/certificate-authority-service?ref=v36.2.0"
  project_id     = module.dev-sec-project.project_id
